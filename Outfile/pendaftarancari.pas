...
var
  fpendataancari: Tfpendataancari;
...
procedure Tfpendataancari.btkeluarClick(Sender: TObject);
begin
  close;
end;

procedure Tfpendataancari.FormShow(Sender: TObject);
begin
...
procedure Tfpendataancari.lookkecPropertiesChange(Sender: TObject);
begin
  //zqkecamatan.Locate('tmkecamatan_kode',lookkec.EditValue,[]);
end;

procedure Tfpendataancari.cxLookupComboBox3PropertiesChange(
  Sender: TObject);
begin
  //zqkecamatanbu.Locate('tmkecamatan_kode',lookkecbu.EditValue,[]);
end;

procedure Tfpendataancari.cari;
var
   i:integer;
   param1,
   param2,
...
procedure Tfpendataancari.btcariClick(Sender: TObject);
var
baris,kolom:integer;
begin
  cari;
...
procedure Tfpendataancari.btresetClick(Sender: TObject);
begin
  nomor.Text          := '';
  lookjenis.Text := '';
  lookgol.Text   := '';
...
procedure Tfpendataancari.FormClose(Sender: TObject;
...
procedure Tfpendataancari.cxButton1Click(Sender: TObject);
begin
